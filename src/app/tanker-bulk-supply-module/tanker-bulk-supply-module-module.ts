...
import { TankerBulkSupplyModuleRoutingModule } from './tanker-bulk-supply-module-routing-module';
...
@NgModule({
  declarations: [
    TankerBulkSupply,
    TankerBulkSupplyOverview,
    TankerBulkSupplySuppliersFleet,
    TankerBulkSupplyFillingStation,
    TankerBulkSupplyTripLogsTracking,
    TankerBulkSupplyBillingRevenue,
    TankerBulkSupplyViolationsEnforcement
  ],
  imports: [
    CommonModule,
    TankerBulkSupplyModuleRoutingModule
  ]
})
export class TankerBulkSupplyModuleModule { }
